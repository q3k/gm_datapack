...
class ILuaInterface001
{
	public:
		...
		virtual int			GetInteger( int i = -1 ) = 0; //10
		...
		virtual void		GetTable( int i = -1 ) = 0; //15
		...
		virtual void		Push( const char* str ) = 0; //20
		...
		virtual void		SetGlobal( const char* namename, ILuaObject* obj = 0 ) = 0; //25
		...
		virtual void		NewTable( void ) = 0; //30
		...
		virtual bool			Call( int args, int returns = 0 ) = 0; //35
		...
		virtual bool			isUserData( int i = -1 ) = 0; //45
		...
		virtual ILuaObject*		GetReturn( int iNum ) = 0; //50
		...
		virtual void			SetMember( ILuaObject* table, float namename, ILuaObject* member ) = 0; //55
...
class ILuaInterface002 : public ILuaInterface001
{
	public:
		...
		virtual void	SetIsServer( bool b ) = 0; //60
		...
		virtual bool	FindOnObjectsMetaTable( int iObject, int iKey ) = 0; //65
		...
		virtual void	Error( const char* strError ) = 0; //70
		...
		virtual bool FindAndRunScript( const char* strFilename, bool bRun, bool bReportErrors ) = 0; //73
